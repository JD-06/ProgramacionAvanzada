...
import sistemapos.controlador.ClientesController;
...
public class ClientesFrame extends JInternalFrame {
    ...
    public ClientesFrame(GestorClientes gestor, Runnable onActualizacion) {
        super("Socios", true, true, true, true);
        this.onActualizacion = onActualizacion;
        setSize(520, 420);
        setLocation(70, 70);
        initUI();
        controller = new ClientesController(this, gestor);
    }
    ...
    private JPanel buildPanelFormulario() {
        ...
        panel.setBorder(BorderFactory.createTitledBorder("Alta de Socio"));
    ...
    private JPanel buildPanelTabla() {
        ...
        panel.setBorder(BorderFactory.createTitledBorder("Listado de Socios"));
